...
function initTraining() {
  ...
  const dayId = parseInt(params.get('day') || '1', 10);
  ...
  fetchMyPlan().then(async (plan) => {
    ...
    const day = plan.weeks.find((d) => d.dayId === dayId) || plan.weeks[dayId - 1] || plan.weeks[0];
    trainingState.planDayId = day.dayId || dayId;
